...
import { dashboardMenu as Menu, main as Main, accountPlan as AccountPlan, transaction as Transaction, extract as Extract } from '../../components/index';
...
const Dashboard = {
    ...
    components: [
        ...
        { id: 'bankstatement', component: Extract },
